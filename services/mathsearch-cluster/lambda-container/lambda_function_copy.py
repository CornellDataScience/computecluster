...
# TODO this will have to be changed from S3 to our local solution
# TODO we can probably just delete this
...
def new_download_files(pdf_name, query_name, png_converted_pdf_path, pdfs_from_bucket_path):
...
# TODO this will havet o be changed from S3 to our local solution
